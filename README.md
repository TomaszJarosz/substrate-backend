...
- [`chain_spec.rs`](nodes/node-template/src/chain_spec.rs): A [chain specification](https://docs.substrate.io/build/chain-spec/) is a source code file that defines a Substrate chain's initial (genesis) state.
...
- [`service.rs`](nodes/node-template/src/service.rs): This file defines the node implementation.
...
Review the [FRAME runtime implementation](runtimes/runtime-template/src/lib.rs) included in this template and note the following:
